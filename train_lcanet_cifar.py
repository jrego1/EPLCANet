...
lca_result_dir = f'/storage/jr3548@drexel.edu/LCANet/{dict_learning}/{dict_loss}/{date}/{lca_lambda}/w_bias/'
...
class LCANet(nn.Module):
    def __init__(self, lca):
        ...
        self.lca = lca
        self.conv1 = nn.Conv2d(64, 128, kernel_size=(3, 3), padding=1, bias=True)
        self.conv2 = nn.Conv2d(128, 256, kernel_size=(3, 3), stride=1, padding=1, bias=True) # Originally true, maybe that helped me?
        self.conv3 = nn.Conv2d(256, 512, kernel_size=(3, 3), stride=1, padding=1, bias=True)
        self.conv4 = nn.Conv2d(512, 512, kernel_size=(3, 3), stride=1, padding=1, bias=True) 
